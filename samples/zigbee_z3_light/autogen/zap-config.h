...
#define SL_ZIGBEE_ZCL_GENERATED_REPORTING_CONFIG_DEFAULTS { \
  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0001, 0x0006, 0x0000, CLUSTER_MASK_SERVER, 0x0000, .data.reported={ 1, 65534, 0 } }, /* Endpoint Id: 1, Cluster: On/off, Attribute: on/off */ \
	  ...
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0002, 0x0006, 0x0000, CLUSTER_MASK_SERVER, 0x0000, .data.reported={ 1, 65534, 0 } }, /* Endpoint Id: 2, Cluster: On/off, Attribute: on/off */ \
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0002, 0x0008, 0x0000, CLUSTER_MASK_SERVER, 0x0000, .data.reported={ 1, 65534, 0 } }, /* Endpoint Id: 2, Cluster: Level Control, Attribute: current level */ \
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0002, 0x0300, 0x0000, CLUSTER_MASK_SERVER, 0x0000, .data.reported={ 1, 65534, 0 } }, /* Endpoint Id: 2, Cluster: Color Control, Attribute: current hue */ \
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0002, 0x0300, 0x0001, CLUSTER_MASK_SERVER, 0x0000, .data.reported={ 1, 65534, 0 } }, /* Endpoint Id: 2, Cluster: Color Control, Attribute: current saturation */ \
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0002, 0x0300, 0x0003, CLUSTER_MASK_SERVER, 0x0000, .data.reported={ 1, 65534, 0 } }, /* Endpoint Id: 2, Cluster: Color Control, Attribute: current x */ \
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0002, 0x0300, 0x0004, CLUSTER_MASK_SERVER, 0x0000, .data.reported={ 1, 65534, 0 } }, /* Endpoint Id: 2, Cluster: Color Control, Attribute: current y */ \
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0002, 0x0300, 0x0007, CLUSTER_MASK_SERVER, 0x0000, .data.reported={ 1, 65534, 0 } }, /* Endpoint Id: 2, Cluster: Color Control, Attribute: color temperature */ \
	 } 
